...
import com.raj.service.RegisterService;
...
public class RegisterController {
	...
	public ResponseEntity<String> addData(@RequestBody Register r){
		String msg = "REGISTRATION SUCCESFUL";
		rservice.addData(r);
	...
	public ResponseEntity<Register> getDetails(@PathVariable String rid)
	{
		 Register r=rservice.getdetails(rid);
